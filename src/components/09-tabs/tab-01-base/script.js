// * ----------------------------------------------------------------------------
// * COMPONENTE: Pestañas 01 - Base (Tabs)
// * AUTONOMÍA ESTRICTA: Contiene la lógica funcional para la navegación de pestañas.
// * ----------------------------------------------------------------------------

document.addEventListener('DOMContentLoaded', () => {
    // 1. Obtener el contenedor autónomo del componente de pestañas
    const tabContainer = document.getElementById('tabComponentBase');
